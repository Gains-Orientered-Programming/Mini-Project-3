...
export class ExpenseService {
    ...
    private async setupExpenseConsumer() {
        await subscribeToTopic(this.expenseConsumer, eventTypes.EXPENSE_EVENT, (payload) => {
            const expenseData = JSON.parse(payload.message.value.toString()) as ExpenseModel;
